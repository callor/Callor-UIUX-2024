...
- `<script>`엘리먼트 안에 아래와 같이 코드를 작성합니다. :
...
- 여기서 우리는 두 번째 Promise가 fulfills일 때 반횐된 Blob을 매개변수로 전달받는 URL.createObjectURL() 메서드를 실행하고 있습니다.
...
- 보다 최근의 현대 브라우저에서는 .finally() 메서드를 사용할 수 있습니다.
